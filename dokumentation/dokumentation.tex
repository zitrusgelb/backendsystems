...
Integration tests verify the interaction of multiple modules, particularly ervices, using Quarkus-Test. These tests run in a Quarkus test instance with an in-memory database.
